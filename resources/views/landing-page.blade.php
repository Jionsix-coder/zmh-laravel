		...
		<div class="row">
			<div class="col-sm-6">
				<div class="item">
					...
					<h4 style="font-size:12px;font-weight:bold;"> +95-9-898155551,+95-9-775545655</h4>
				</div>
				<br>
			</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<hr>
				<h4><p class="officer-text">အမည် </p>- <em>{{ $officer->name }}</em></h4>
				<h4><p class="officer-text">ဖုန်းနံပါတ် </p>- <em>+95{{ $officer->phnumber }}</em></h4>
				<h4><p class="officer-text">ရာထူး </p>- <em>{{ $officer->currentposition }}</em></h4>
