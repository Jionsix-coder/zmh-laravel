        ...
        <div class="header__top">
            <div class="ps-container">
                <div class="header__left">
                    ...
                    </div><a class="ps-logo" href="index.html"><img src="img/bg/logo.png" width="40px" height="40px" alt="" style="margin-right: 10px;"><img src="img/logo.png" alt="logo.png"></a>
                </div>
                <div class="header__center">
                    <form class="ps-form--quick-search" action="index.html" method="get">
                        ...
                        <input class="form-control" type="text" placeholder="ပစ္စည်းများရှာရန်" id="input-search">
                ...
                <div class="header__right">
                    <div class="header__actions"><a class="header__extra" href="whishlist.html"><i class="icon-heart"></i><span><i>0</i></span></a>
                        <div class="ps-cart--mini"><a class="header__extra" href="shopping-cart.html"><i class="icon-bag2"></i><span><i>0</i></span></a>
                            <div class="ps-cart__content">
                                ...
                                <div class="ps-cart__footer">
                                    ...
                                    <figure><a class="ps-btn" href="#"></a><a class="ps-btn" href="checkout.html">Checkout</a></figure>
                                </div>
                            </div>
                        </div>
                        <div class="ps-block--user-header">
                            <div class="ps-block__left"><a href="profile.html"><i class="icon-user"></i></a></div>
                            <div class="ps-block__right"><a href="profile.html" style="text-align: center;">My</a><a href="profile.html">Account</a></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="ps-container">
                ...
                <div class="navigation__right">
                    <ul class="menu">
                        ...
                        <li class="menu-item-has-children has-mega-menu"><a href="shop-default.html">စျေးဝယ်ရန်</a></li>
                        <li class="menu-item-has-children has-mega-menu"><a href="#">စည်းမျဉ်းစည်းကမ်း</a></li>
                        <li class="menu-item-has-children has-mega-menu"><a href="#">ဆက်သွယ်ရန်</a></li>
                    </ul>
                    <ul class="navigation__extra">
                        <li><a href="#">အဖွဲ့ဝင်များသိထားရန်</a></li>
                        <li><a href="#">အဖွဲ့ဝင်သစ်လိုအပ်ချက်</a></li>
                        <li><a href="">အာမခံ</a></li>
                        <li><a href="">အကောင့်</a></li>
                    </ul>
                </div>
            </div>
        </nav>
